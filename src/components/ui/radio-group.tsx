  ...
  return (
    ...
    >
      <RadioGroupPrimitive.Indicator
        ...
        className="relative flex items-center justify-center bg-blue-700"
      >
        <FaCheck  className="fill-black absolute top-1/2 left-1/2 size-2 -translate-x-1/2 -translate-y-1/2" />
      </RadioGroupPrimitive.Indicator>
    </RadioGroupPrimitive.Item>
  )
}
